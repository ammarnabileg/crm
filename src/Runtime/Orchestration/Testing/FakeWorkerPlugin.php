...
/**
 * A real, minimal {@see WorkerPlugin} the Runtime's own tests and safe defaults use.
 *
 ...
 * stub of the platform. The Runtime orchestration tests dispatch it through the real
 * {@see \Nizam\Runtime\Orchestration\WorkerCoordinator} to prove that workers are only ever invoked
 * through the Runtime and never reach one another. Its constructor is side-effect free, honouring the
 * SDK guidance. The declared required permission lets tests exercise the coordinator's permission gate.
 */
final class FakeWorkerPlugin implements WorkerPlugin
{
    ...
    public function manifest(): PluginManifest
    {
        return PluginManifest::create(
            ...
            description: 'A minimal worker plugin used by the Runtime test suite and safe defaults.',
