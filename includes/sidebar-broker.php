...
<div class="w-64 bg-gray-900 text-white min-h-screen flex flex-col flex-shrink-0">
  <div class="p-4 border-b border-gray-700">
    ...
    <div class="text-xs text-[#F5C518] mt-1">وسيط عقاري</div>
  </div>
  <nav class="flex-1 p-4 space-y-1">
    <?php
    $links = [
      ['/broker/', 'لوحة التحكم', 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6'],
      ['/broker/leads.php', 'العملاء المحالون', 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z'],
    ...
    foreach ($links as [$href, $label, $icon]):
        $isActive = ($current === $href) || ($href !== '/broker/' && strpos($current, $href) !== false);
    ?>
