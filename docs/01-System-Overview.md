...
| **Agent Framework** | Selects a plan for an intent and drives it step by step, applying guardrails and memory scoping. | Each step resolves to a tool; the framework decides *which* and *in what order*. |
